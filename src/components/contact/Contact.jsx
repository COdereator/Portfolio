...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ex31s4h', 'template_j1amlpk', form.current,'NzOZ6w59ZRHOpcU2c',
      )
     e.target.reset()
  };  
  return (
            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                  <div className="contact_card">
                    ...
                    <div className="contact_card-data">user@gmail.com</div>
                  ...
                  <div className="contact_card">
                    ...
                    <div className="contact_card-data">97343477378</div>

                    <a href="https://api.whatsapp.com/send?phone=9730508603&text=Hello, more information! " className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                  </div>
                  ...
                  <div className="contact_card">
                    ...
                    <div className="contact_card-data">user.fb123</div>
