...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Code_Creator
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">I'm creative designer based i India, and I'm very passionate and dedicated to my work</p> 
